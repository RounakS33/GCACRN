...
class BaseModel(ABC):
    ...
    def eval_in_training(self, input):
        pass
            ...
            if isinstance(name, str):
                ...
                if len(self.gpu_ids) > 0 and torch.cuda.is_available():
                    torch.save({
                        ...
                        'optimizer_states': [opt.state_dict() for opt in self.optimizers] if self.isTrain else None
                    }, save_path)
        ...
        for name in self.model_names:
            if isinstance(name, str):
                ...
                if isinstance(checkpoint, dict) and 'model_state_dict' in checkpoint:
                    ...
                    if self.isTrain and checkpoint.get('optimizer_states') is not None:
