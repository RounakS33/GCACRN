...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--update_html_freq', type=int, default=2500,
        ...
        parser.add_argument('--eval_epoch_freq', type=int, default=1,
                            help='frequency of running validation at the end of epochs')
        ...
        parser.add_argument('--lr_G', type=float, default=0.0002,
                            help='initial learning rate for generator optimizer')
        parser.add_argument('--lr_D', type=float, default=0.0001,
                            help='initial learning rate for discriminator optimizer')
        ...
        parser.add_argument('--dataset_size', type=int, default=5000,
                            help='train dataset size, 0 means the whole set.')
