...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--pretrained_dir', type=str, default='./pretrained_IBCLN',
                            help='directory containing pretrained IBCLN model')
        # model parameters
        ...
        parser.add_argument('--input_nc', type=int, default=3,
                            help='# of input image channels: 3 for RGB and 1 for grayscale, 6 for reflection removal')
        ...
        parser.add_argument('--netG', type=str, default='gen_drop',
        ...
        # dataset parameters
        parser.add_argument('--use_all_natural', action='store_true',
                            help='if specified, use all natural images in the dataset')
